...
You need one thing on the new PC besides MySQL: `SmartBatch360 V5.exe` (bundles
...
Unzip `SmartBatch360-V5.zip` anywhere, then run `SmartBatch360 V5.exe` from
the `SmartBatch360 V5` folder inside it. The app
